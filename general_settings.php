          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="backend.php">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-3 col-form-label"><b>Title:</b></label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" placeholder="Enter Site Title" name="title" id="title" value="<?php echo $settings['site_title']; ?>" required autofocus>
                  </div>
                </div>
